...
func TestEvaluateAllow(t *testing.T) {
	...
	if d.Effect != EffectAllow { t.Error("should allow") }
}
func TestEvaluateDeny(t *testing.T) {
	...
	if d.Effect != EffectDeny { t.Error("should deny — implicit") }
}
func TestEvaluateContains(t *testing.T) {
	...
	if d.Effect != EffectAllow { t.Error("should match contains") }
}
func TestEvaluateIn(t *testing.T) {
	...
	if d.Effect != EffectAllow { t.Error("in") }
}
func TestDefaultSecurityPolicy(t *testing.T) {
	...
	if d.Effect != EffectDeny { t.Error("should deny shell exec") }
}
