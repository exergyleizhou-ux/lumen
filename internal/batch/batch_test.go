...
func TestMapProcessor(t *testing.T) {
	...
	if len(out) != 3 { t.Error("count") }
	if !strings.Contains(r.FormatProgress(), "100.0%") { t.Error("progress") }
}
