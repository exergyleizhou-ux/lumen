...
func TestRegistryRegister(t *testing.T) {
	...
	if err != nil || sv.Version != 1 { t.Error("register") }
	if len(r.Subjects()) != 1 { t.Error("subjects") }
}
...
func TestDetectBreakingChange(t *testing.T) {
	...
	if len(issues) == 0 { t.Error("should detect type change") }
}
