...
func (t *HeapSnapshotTool) Description() string { return "Capture a heap memory snapshot showing allocation, GC stats, and goroutine count." }
func (t *HeapSnapshotTool) Schema() json.RawMessage { return json.RawMessage(`{"type":"object","properties":{}}`) }
...
func (t *GoroutineSummaryTool) Description() string { return "Summarize all goroutines by state (running, waiting, IO, etc)." }
func (t *GoroutineSummaryTool) Schema() json.RawMessage { return json.RawMessage(`{"type":"object","properties":{}}`) }
...
func (t *DiagnosticRunTool) Description() string { return "Run full system diagnostics: health probes, connectivity, severity report." }
func (t *DiagnosticRunTool) Schema() json.RawMessage { return json.RawMessage(`{"type":"object","properties":{}}`) }
...
func (t *TraceSpanStartTool) Description() string { return "Start a new trace span for performance measurement." }
...
func (t *RuntimeInfoTool) Description() string { return "Show Go runtime information: version, CPU count, goroutines, memory stats." }
func (t *RuntimeInfoTool) Schema() json.RawMessage { return json.RawMessage(`{"type":"object","properties":{}}`) }
