...
func (t *PolicyEvalTool) Description() string {
	return "Evaluate a policy rule against input data. Returns allow/deny/warn decision."
}
...
func (t *PolicyListTool) Schema() json.RawMessage {
...
func (t *PolicyAuditLogTool) Schema() json.RawMessage {
	return json.RawMessage(`{"type":"object","properties":{}}`)
}
