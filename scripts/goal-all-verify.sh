...
run_gate sqlite-session env LUMEN_SQLITE_STORE=on go test -count=1 -v ./internal/lumenstore/... ./internal/audit/... ./internal/agent/... -run 'SQLite|Migrate|SessionMessages|MutationMatrix|DualWrite|AutoMigrate|DropLast|Concurrent|CompactRewrites|CompactSQLite|EmptyJSONL|UnreadableJSONL'
