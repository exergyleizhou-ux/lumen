...
print("note: rows are a SELF-REPORTED checklist (policy/CC_PARITY.md); only the")
print("      cargo test sections above are executed evidence. Binding each")
print("      scenario to a runnable test is tracked in docs/go-era-branch-map.md.")
if rate < 0.80:
