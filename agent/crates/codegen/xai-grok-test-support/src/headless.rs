...
/// Run a caller-built command (env already applied) and capture stdout/stderr
/// with the scaled headless timeout. Retained for callers that assemble the
/// command themselves (e.g. `test_core_contracts`).
