...
pub(super) fn running_seed<C>(child: &ActiveChild<C>) -> RunningSeed {
    RunningSeed {
        ...
        root_session_id: child.request.lineage.root_session_id.clone(),
        depth: child.request.lineage.depth,
        lineage_path: child.request.lineage.lineage_path.clone(),
...
pub(super) fn running_inspection(
    ...
    SubagentInspection {
        ...
        root_session_id: seed.root_session_id,
        depth: seed.depth,
        lineage_path: seed.lineage_path,
