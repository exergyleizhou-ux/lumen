...
fn prompted_decision_approved(
    decision: &crate::permission::types::Decision,
    outcome_str: &str,
) -> Option<bool> {
    match decision {
        crate::permission::types::Decision::Allow => Some(true),
        crate::permission::types::Decision::Reject(_) if outcome_str != "error" => Some(false),
        _ => None,
    }
}
