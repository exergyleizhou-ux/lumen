...
pub use config::{
    AuthScheme, BearerResolver, HeaderInjector, OriginClientInfo, RequestObserver, RetryPolicy,
    SamplerConfig, SharedBearerResolver, SharedHeaderInjector, SharedRequestObserver,
};
